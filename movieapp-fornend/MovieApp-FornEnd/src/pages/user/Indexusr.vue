<template>
  <q-page padding>
    <div class="q-mb-xl col-gutter-md">
      ...
      >
        <q-carousel-slide :name="1" img-src="https://gagafood.co.id/wp-content/uploads/2020/11/ComingSoon.jpg" />
        <q-carousel-slide :name="2" img-src="https://2.bp.blogspot.com/-_otRnPM2484/WDwS_xMUAgI/AAAAAAAArq0/UImQOsb-qqAE0CsPBZO1TiQM_bPn483vwCLcB/s1600/Twenty-One-Mall.jpg" />
        <q-carousel-slide :name="3" img-src="https://cdn.quasar.dev/img/parallax2.jpg" />
        <q-carousel-slide :name="4" img-src="https://gondomananpusk.jogjakota.go.id/assets/instansi/gondomananpusk/article/20200722091100.png" />
      </q-carousel>
    </div>
