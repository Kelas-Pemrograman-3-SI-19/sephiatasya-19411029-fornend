            ...
            <q-card-section>
              ...
              >
                <q-input
                  ...
                  label="Username"
                  :rules="[
                  val => val && val.length > 0 || 'Tolong Masukan Username Anda'
                  ]"
                />
                <q-input
                  v-model="namaLengkap"
                  label="Nama Lengkap"
                  :rules="[
                  val => val && val.length > 0 || 'Tolong Masukan Nama Lengkap Anda'
                  ]"
                />
                <q-input
                  v-model="email"
                ...
                <q-input
                  ...
                  type="password"
                  :rules="[
                  val => val && val.length > 0 || 'Tolong Masukan Password Anda'
                  ]"
                />
