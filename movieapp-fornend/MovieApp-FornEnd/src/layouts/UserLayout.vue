<template>
  <q-layout view="lHh Lpr lFf">
    <q-toolbar unelevated style="height: 70px;" class="bg-teal-5 text-blue-grey-14">
      <div class="text-h6 q-ml-lg">Cinema Movie</div>
      ...
      <div v-if="$q.screen.md || $q.screen.md || $q.screen.lg || $q.screen.xl">
        ...
        <q-btn size="medium" @click="logout()">Logout</q-btn>
      </div>
